export const impactMetrics = [
  {
    value: "40+",
    label: "Dialogue sessions held",
    detail: "Campus, community, and online circles since founding",
  },
  {
    value: "500+",
    label: "Young people engaged",
    detail: "Participants across Talk It programmes and events",
  },
  {
    value: "30+",
    label: "Peer facilitators trained",
    detail: "Volunteers practising structured, careful dialogue",
  },
  {
    value: "5+",
...
export const impactPillars = [
  ...
  },
  {
    ...
    body: "Impact is not only attendance. It is peers who return ready to facilitate, mentor, and hold space for others.",
  },
  {
    title: "Communities that listen",
    body: "When campuses and neighbourhoods adopt dialogue, mental health and leadership stop being solitary burdens.",
  },
] as const;
...
export const impactQuotes = [
  ...
  {
    quote:
      "When our hub co-hosted a circle, young people asked for the next date before we had finished packing up.",
    name: "Grace K.",
